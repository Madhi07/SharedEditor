...
function TypingHeadline() {
    ...
    useEffect(() => {
      ...
      <span class='bg-gradient-to-r from-indigo-500 to-violet-500 bg-clip-text text-transparent font-bold'>AI</span><br/><span className='bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent font-bold'>Agents</span> 
      is Here`;
